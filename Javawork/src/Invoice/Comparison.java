...
public class Comparison {
	...
	public void comparison_Invoice () {
		...
		number = scanner.next();
		int afterConvert = Integer.parseInt(number);
		afterConvert = afterConvert%10000000;
		String frist_Number = String.valueOf(afterConvert); //七碼 ４Ｗ
		afterConvert = afterConvert%1000000;
		String second_Number = String.valueOf(afterConvert); //六碼 １Ｗ
		afterConvert = afterConvert%100000;
		String third_Number = String.valueOf(afterConvert); //五碼 ４０００
		afterConvert = afterConvert%10000;
		String fourth_Number = String.valueOf(afterConvert); //四碼 １０００
		afterConvert = afterConvert%1000;
		String fifth_Number = String.valueOf(afterConvert); //三碼 ２００
